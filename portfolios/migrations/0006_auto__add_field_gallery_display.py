...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gallery.display'
        db.add_column('portfolios_gallery', 'display',
                      self.gf('django.db.models.fields.CharField')(default='Galleria', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gallery.display'
        db.delete_column('portfolios_gallery', 'display')
    ...
    models = {
        ...
        'portfolios.gallery': {
            ...
            'display': ('django.db.models.fields.CharField', [], {'default': "'Galleria'", 'max_length': '8'}),
