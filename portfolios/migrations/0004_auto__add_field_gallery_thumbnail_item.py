...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gallery.thumbnail_item'
        db.add_column('portfolios_gallery', 'thumbnail_item',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='+', null=True, on_delete=models.SET_NULL, to=orm['portfolios.Item'], blank=True, unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gallery.thumbnail_item'
        db.delete_column('portfolios_gallery', 'thumbnail_item_id')
