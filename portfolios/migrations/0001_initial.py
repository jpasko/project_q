...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('portfolios_gallery', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=75, blank=True)),
            ('count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=9999, blank=True)),
            ('thumbnail', self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('portfolios', ['Gallery'])

        # Adding model 'Item'
        db.create_table('portfolios_item', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gallery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['portfolios.Gallery'])),
            ('is_photo', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('caption', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=9999, blank=True)),
        ))
        db.send_create_signal('portfolios', ['Item'])

        # Adding model 'Photo'
        db.create_table('portfolios_photo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['portfolios.Item'], unique=True)),
            ('image', self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100)),
        ))
        db.send_create_signal('portfolios', ['Photo'])

        # Adding model 'Video'
        db.create_table('portfolios_video', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['portfolios.Item'], unique=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal('portfolios', ['Video'])


    def backwards(self, orm):
        # Deleting model 'Gallery'
        db.delete_table('portfolios_gallery')

        # Deleting model 'Item'
        db.delete_table('portfolios_item')

        # Deleting model 'Photo'
        db.delete_table('portfolios_photo')

        # Deleting model 'Video'
        db.delete_table('portfolios_video')
