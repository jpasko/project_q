...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.enable_slideshow'
        db.add_column('accounts_userprofile', 'enable_slideshow',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.slow_slideshow'
        db.add_column('accounts_userprofile', 'slow_slideshow',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.skip_text'
        db.add_column('accounts_userprofile', 'skip_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.slideshow_image_1'
        db.add_column('accounts_userprofile', 'slideshow_image_1',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.slideshow_image_2'
        db.add_column('accounts_userprofile', 'slideshow_image_2',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.slideshow_image_3'
        db.add_column('accounts_userprofile', 'slideshow_image_3',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.enable_slideshow'
        db.delete_column('accounts_userprofile', 'enable_slideshow')

        # Deleting field 'UserProfile.slow_slideshow'
        db.delete_column('accounts_userprofile', 'slow_slideshow')

        # Deleting field 'UserProfile.skip_text'
        db.delete_column('accounts_userprofile', 'skip_text')

        # Deleting field 'UserProfile.slideshow_image_1'
        db.delete_column('accounts_userprofile', 'slideshow_image_1')

        # Deleting field 'UserProfile.slideshow_image_2'
        db.delete_column('accounts_userprofile', 'slideshow_image_2')

        # Deleting field 'UserProfile.slideshow_image_3'
        db.delete_column('accounts_userprofile', 'slideshow_image_3')
    ...
    models = {
        ...
        'accounts.userprofile': {
            ...
            'background_color': ('django.db.models.fields.CharField', [], {'default': "'F7F7F7'", 'max_length': '6'}),
            ...
            'enable_slideshow': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'page_width': ('django.db.models.fields.PositiveIntegerField', [], {'default': '930'}),
            ...
            'skip_text': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),
            'slideshow_image_1': ('imagekit.models.fields.ProcessedImageField', [], {'max_length': '100', 'null': 'True'}),
            'slideshow_image_2': ('imagekit.models.fields.ProcessedImageField', [], {'max_length': '100', 'null': 'True'}),
            'slideshow_image_3': ('imagekit.models.fields.ProcessedImageField', [], {'max_length': '100', 'null': 'True'}),
            'slow_slideshow': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'text_color': ('django.db.models.fields.CharField', [], {'default': "'5E5E5E'", 'max_length': '6'}),
            'text_color_hover': ('django.db.models.fields.CharField', [], {'default': "'A1A1A1'", 'max_length': '6'}),
            'thumbnail_dimension': ('django.db.models.fields.PositiveIntegerField', [], {'default': '225'}),
