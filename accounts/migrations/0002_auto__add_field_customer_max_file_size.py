...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.max_file_size'
        db.add_column('accounts_customer', 'max_file_size',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.max_file_size'
        db.delete_column('accounts_customer', 'max_file_size')
